...
<body id="reg">
	...
	<div id="container" class="noXtips cf">
		<div class="main">
			...
			<div class="reg-notes">
			<p><font color="red" size="+2">${msg }</font></p>
				<p>如果你已注册，请直接登录</p>
	...
	<script type="text/javascript">
		...
		$(function(){
			$("#username").blur(function(){
				...
				$.ajax({
					type:"post",
					url:"${pageContext.request.contextPath}/checkUserNameExit.do?username="+username,
					contentType:"application/json;charset=utf-8",
					success:function(data){
						if(data!=0){
							alert("该账号已经被使用,请重新输入！");
							$("#username").val("");
		...
		/*$(function(){
			$("#username").blur(function(){
				...
				$.ajax({
					type:"post",
					url:"${pageContext.request.contextPath }/user/checkUserNameExit.do?username="+name,
					contentType:"application/json;charset=utf-8",
					success:function(data){
						if(data==0){
		...
		$(function(){
			$("#checkcode").blur(function(){
				...
				$.ajax({
					type:"post",
					url:"${pageContext.request.contextPath }/user/checkcode.do?checkcode="+checkcode,
					contentType:"application/json;charset=utf-8",
					success:function(data){
						 if(data==1){
