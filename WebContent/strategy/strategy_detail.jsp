...
<div id="mainWrapper" class="cf"> 
	...
	<!-- 发帖人 -->
        ...
        <div class="tag-list menu_select cf">
            ...
            <span class="tag-cnt fn-right" id="lyq"><a href="#" data-lyq="0"><c:if test="${strategy.stypesid ==1001 }">主题游</c:if><c:if test="${strategy.stypesid ==2001 }">时令游</c:if></a></span>
        </div>
         <!--end 发帖人 -->
        ...
        <div class="tag-list menu_select cf">
            ...
            <span class="tag-cnt fn-right" id="lyq"><a href="#"  data-lyq="0">${strategy.tspppeople }</a></span>
        </div>
         <!--end 目的地 -->
        ...
        <div class="tag-list menu_select cf">
            ...
            <span class="tag-cnt fn-right" id="lyq">${strategy.tsequip }
        </div>
         <!--end 联系方式 -->
		  <!-- 联系方式 -->
        <div class="tag-list menu_select cf">
